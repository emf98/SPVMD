...
**SPVDM** is a repository containing code associated with the best-fit calculation of stratospheric polar vortex ellipse geometries/metrics for application to analyses.  
Code from this folder supports a manuscript submitted to the AMS Journal of Applied Meteorology and Climatology by Fernandez, Attard, and Lang 2025 (*under review*). 
